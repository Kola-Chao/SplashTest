 ...
 */
val icon_first = Color(0xFF171719)
val theme_color = Color(0xFFFBFF1C)//主题色
val background_light = Color(0xFFF6F7F8)//bg_bg_浅色背景
val text_title = Color(0xFF171719)//text_text_主文字_标题
val text_content = Color(0xFF626973)//text_text_主文字_正文
val border_color = Color(0xFFE9ECF0)//分割线
val disabled_color = Color(0xFFDFE2E6)//禁用色
val text_auxiliary = Color(0xFF8A9099)//text_text_辅助文字
val border_light = Color(0xFFE9ECF0)//border_border_浅灰描边

val color_FF949494 = Color(0xFF949494)
val color_B3FFFFFF = Color(0xB3FFFFFF)
val color_FF15141F = Color(0xFF15141F)
val color_FF626973 = Color(0xFF626973)
val color_FF2681FF = Color(0xFF2681FF)
val color_80FFFFFF = Color(0x80FFFFFF)
val color_FFFAFAFA = Color(0xFFFAFAFA)
val color_FFFFE70B = Color(0xFFFFE70B)
val color_FFFFE301 = Color(0xFFFFE301)
val color_FFB64E03 = Color(0xFFB64E03)
val color_FFBA350C = Color(0xFFBA350C)
val color_FF0D6800 = Color(0xFF0D6800)
val color_FF41210A = Color(0xFF41210A)
val color_FFFF4040 = Color(0xFFFF4040)
val color_FF398F0E = Color(0xFF398F0E)
val color_FFB65302 = Color(0xFFB65302)
val color_FFA8A8A8 = Color(0xFFA8A8A8)
val color_FFF4F2F0 = Color(0xFFF4F2F0)
val color_FFC66014 = Color(0xFFC66014)
val color_FF2BA51E = Color(0xFF2BA51E)
val color_FF347906 = Color(0xFF347906)
val color_FFFDDE1C = Color(0xFFFDDE1C)
val color_FFFC9313 = Color(0xFFFC9313)
val color_FF340909 = Color(0xFF340909)
val color_FFFEF7D3 = Color(0xFFFEF7D3)
val color_FFF9EDC7 = Color(0xFFF9EDC7)
val color_FF237C0B = Color(0xFF237C0B)
val color_FF0E6500 = Color(0xFF0E6500)
val color_FF29BB40 = Color(0xFF29BB40)
val color_FF00CE00 = Color(0xFF00CE00)
val color_FF03B103 = Color(0xFF03B103)
val color_FF321500 = Color(0xFF321500)
val color_FF9DE703 = Color(0xFF9DE703)
val color_FF9DE602 = Color(0xFF9DE602)
val color_FF509A01 = Color(0xFF509A01)
val color_FFFF2626 = Color(0xFFFF2626)
val color_FFFC6915 = Color(0xFFFC6915)
val color_FF02BD02 = Color(0xFF02BD02)
val color_FFD3433E = Color(0xFFD3433E)
val edittext_background = Color(0xFFF4F7FE)
val edittext_error_background = Color(0xFFFEF5F4)
val edittext_hint = Color(0xFF9C9DA6)
val edittext_title = Color(0xFF121314)
val edittext_focus_border = Color(0xFF4B4B4B)
val edittext_focus_error_border = Color(0xFFFF493E)
val color_FF02BB02 = Color(0xFF02BB02)
val color_FFCFCFCF = Color(0xFFCFCFCF)
